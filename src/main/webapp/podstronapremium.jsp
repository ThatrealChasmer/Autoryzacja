...
<body>
	...
	<form action="login.jsp">
		<input type="submit" value="Strona Logowania">
	</form>
	<form action="grantStatus.jsp">
		<input type="submit" value="Nadaj Status">
	</form>
	<form action="listUsers.jsp">
		<input type="submit" value="Lista Użytkowników">
	</form>
	<form action="register.jsp">
		<input type="submit" value="Rejestracja">
	</form>
	<form action="premium.jsp">
		<input type="submit" value="Strona Premium">
	</form>
	<p>
		żródło: <a href="https://codepen.io/cihadturhan/pen/jwipD">Tutaj</a>
<div id="holder">
            <div id="viewport">
